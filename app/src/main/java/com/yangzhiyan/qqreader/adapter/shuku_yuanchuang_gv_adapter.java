...
public class shuku_yuanchuang_gv_adapter extends BaseAdapter {
    private YuanChuangClass yuanChuangClass;
    private Context context;

    public shuku_yuanchuang_gv_adapter(YuanChuangClass yuanChuangClass, Context context) {
    ...
    @Override
    public int getCount() {
        return yuanChuangClass.recmd.size();
    }

    @Override
    public Object getItem(int position) {
        return yuanChuangClass.recmd.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvtitle.setText(yuanChuangClass.recmd.get(position).title);
        holder.tvintro.setText(yuanChuangClass.recmd.get(position).intro);
        switch (position){
            case 0:
        ...
        String imgurl = yuanChuangClass.recmd.get(position).image;
