...
public class shuku_yuanchuang_lv_adapter extends BaseAdapter {
    ...
    public shuku_yuanchuang_lv_adapter(YuanChuangClass yuanChuangClass, Context context) {
    ...
    @Override
    public int getCount() {
        if (yuanChuangClass.boyCategoryList==null){
            return 0;
        }
        return yuanChuangClass.boyCategoryList.size();
    }

    @Override
    public Object getItem(int position) {
        return yuanChuangClass.boyCategoryList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvtitle.setText(yuanChuangClass.boyCategoryList.get(position).categoryName);
        holder.tvcount.setText("共"+yuanChuangClass.boyCategoryList.get(position).bookCount+"册");
        bids = yuanChuangClass.boyCategoryList.get(position).bids;
        bid = bids.split(",");
